<template>
  <div class="exam">
      ...
      <div class="buttons-group">
          <Button type="success" size="large" @click.native="prevItem" :disabled="currendIndex<1 && currendIndex != examList.length-1">上一题</Button>
          <Button type="success" size="large" @click.native="nextItem" v-if="currendIndex != examList.length-1">下一题</Button>
          <Button type="success" size="large" @click.native="handleSubmit" v-if="currendIndex == examList.length-1">提交试卷</Button>
      </div>
  </div>
</template>
